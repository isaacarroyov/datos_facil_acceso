...
#'
#' De acuerdo con el sitio oficial del _North American Drought Monitor_: 
#' 
...
#' de América.
#' 
#' En México, el [Monitor de Sequía de México (MSM)]() es encargado de compartir 
#' la información de la sequía en México. Los datos del MSM han sido 
#' procesado y se encuentran en la carpeta [GobiernoMexicano/msm](https://github.com/isaacarroyov/datos_facil_acceso/tree/main/GobiernoMexicano/msm)
#' 
